...
// ==========================================
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxNIpw3F6EhovhIlWQkMM1Hb9L6NGh1IWw_T12_7ItXcwP-xN6SqswULdcfhGByEFCf/exec"; 
...
async function fetchDariSheet() {
    try {
        ...
        dataLokal = data; 
        console.log("Data berhasil dimuat dari Sheets");
        return data;
    } catch (error) {
